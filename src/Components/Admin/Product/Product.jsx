...
export default function Product() {
    const columns = [
        ...
        {
            field: 'pic1', headerName: 'Pic1', width: 100, renderCell: ({ row }) => <a href={`/product/${row.pic1}`} target='_blank' rel='noreferrer'>
                <img src={`/product/${row.pic1}`} height="80px" width="80px" alt="" />
            </a>
        },
        {
            field: 'pic2', headerName: 'Pic2', width: 100, renderCell: ({ row }) => <a href={`/product/${row.pic2}`} target='_blank' rel='noreferrer'>
                <img src={`/product/${row.pic2}`} height="80px" width="80px" alt="" />
            </a>
        },
        {
            field: 'pic3', headerName: 'Pic3', width: 100, renderCell: ({ row }) => <a href={`/product/${row.pic3}`} target='_blank' rel='noreferrer'>
                <img src={`/product/${row.pic3}`} height="80px" width="80px" alt="" />
            </a>
        },
        {
            field: 'pic4', headerName: 'Pic4', width: 100, renderCell: ({ row }) => <a href={`/product/${row.pic4}`} target='_blank' rel='noreferrer'>
                <img src={`/product/${row.pic4}`} height="80px" width="80px" alt="" />
            </a>
        },
        {
            field: 'edit',
